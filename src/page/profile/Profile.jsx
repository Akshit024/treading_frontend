            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">14/02/2004</p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">sec-3</p>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">200412</p>
                </div>
                <div className="flex">
          ...
          <Card>
            <CardHeader className="pb-7">
              <div className="flex items-center gap-3">
                ...
                {true ? (
                  <Badge className={"space-x-2 bg-green-600 text-white"}>
                    <VerifiedIcon />
                    Enabled
                  </Badge>
                ) : (
